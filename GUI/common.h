...
#define SETTINGS_FILE "IgnoreTouchpad Settings"
...
// resources
#define ACTIVE_ICON "IT:ON"				// "Ignore Touchpad" is enabled - so one of the devices is disabled.
#define INACTIVE_ICON "IT:OFF"			// "Ignore Touchpad" is disabled - all devices are enabled.
